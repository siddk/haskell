...
-- Tuples
--          Designated with '(' ')'
--          Can have multiple types (strings, ints)
--          Comparison works like list comparisons
--
-- Tuple functions
--          fst --> takes a pair, returns first element
--          snd --> takes a pair, returns second element
--          zip --> takes two lists, returns list of tuples with
--                  each sequential element bound to the
